...
if ( ! function_exists( 'iweb_template_loop_item' ) ) :
    /* Loop template */
    function iweb_template_loop_item( $iweb_widget_elmentor_class_col ) {
...
add_action( 'iweb_template_loop', 'iweb_template_loop_item', 5 );
...
function iweb_template_load_item() {
    ...
    while ( $iweb_widget_template_load_query -> have_posts() ) :
        ...
        do_action( 'iweb_template_loop', $iweb_temlate_load_class_col );
